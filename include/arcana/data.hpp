...
#include <vector>
namespace arcana {
struct EnemyDef { std::string name, behavior, sprite, shotSprite; double hp{},speed{},damage{},xp{},size{},radius{}; };
struct PhaseDef { std::string name,floor,color,boss,bossName; std::array<std::string,2> enemies; };
struct CampaignDef { std::string name; double seconds{},xp{},coins{},bossHp{}; bool endless{}; };
